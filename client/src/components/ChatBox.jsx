      ...
      <div className="w-full">
        ...
        >
          <select
            ...
            value={mode}
            className="text-sm pl-3 pr-2 outline-none bg-white text-black dark:bg-purple-900 rounded-full"
          >
          ...
          <input
            ...
            className="flex-1 w-full text-sm outline-none bg-transparent text-black dark:text-white placeholder-gray-400"
            required
          />
