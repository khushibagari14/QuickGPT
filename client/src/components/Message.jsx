    ...
    <div>
      {message.role === "user" ?(
        <div className='flex items-start justify-end my-4 gap-2'>
          <div className='flex flex-col gap-2 p-2 px-4 max-w-2xl 
           bg-slate-50 dark:bg-gradient-to-r dark:from-purple-800 dark:to-purple-900 
            border border-gray-300 dark:border-purple-500 rounded-md'>
